namespace CRUDAppProject.Forms
{
    partial class Form_DeleteProfile
    {
        ...
        private void InitializeComponent()
        {
            ...
            ComboBox_ProfileName.Location = new Point(115, 74);
            ComboBox_ProfileName.Margin = new Padding(3, 11, 3, 11);
            ...
            Button_ExitProfileDeletion.Location = new Point(3, 433);
            Button_ExitProfileDeletion.Margin = new Padding(3, 11, 3, 11);
            ...
            Button_ConfirmProfileDeletion.Location = new Point(3, 306);
            Button_ConfirmProfileDeletion.Margin = new Padding(3, 11, 3, 11);
            ...
            TextBox_RewriteProfileName.Location = new Point(115, 243);
            TextBox_RewriteProfileName.Margin = new Padding(3, 11, 3, 11);
            ...
            Label_RewriteProfileName.Location = new Point(39, 139);
            Label_RewriteProfileName.Margin = new Padding(3, 11, 3, 11);
            ...
            tableLayoutPanel_Menu.Margin = new Padding(3, 11, 3, 11);
            ...
            tableLayoutPanel_Menu.Size = new Size(978, 549);
